...
namespace DigitalLibrary.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            DigitalLibrary.Data.ApplicationDbContext dbContext,
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Save to Member or Librarian table if needed
                    if (Input.Role == "Member")
                    {
                        var member = new DigitalLibrary.Models.Member
                        {
                            FullName = Input.Email, // Update to collect/display real name if needed
                            Email = Input.Email,
                    ...
                    {
                        var librarian = new DigitalLibrary.Models.Librarian
                        {
                    ...
                    var callbackUrl = $"{Request.Scheme}://{Request.Host}/Identity/Account/ConfirmEmail?userId={userId}&code={code}&returnUrl={returnUrl}";
